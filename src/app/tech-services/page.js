...
export const metadata = getSEOTags(
  "CRM Tech Services | Optimize Your Business with Cutting-Edge CRM Solutions",
  "Enhance customer engagement and streamline operations with our expert CRM technology services. From implementation to integration, we deliver tailored CRM solutions for business success."
);

export default function Home() {
  const consultancyTiles = menuData.find((item) => item.id === 2).submenu;
  ...
  return (
    <main className="min-h-screen">
      ...
      <HeroOne
        subhead=""
        title="Enhance customer engagement with our expert CRM tech solutions"
        img="/assets/images/tech-services/tech-services-hero.png"
        bg="#FFF7F0"
      />
