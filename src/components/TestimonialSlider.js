...
const TestimonialSlider = () => {
  const items = [
    ...
    {
      name: "Mary Harrison",
      subhead: "Former Head of Marketing-Hexagon",
      message: `“Charu (CEO- Vegacompass) is a very hard-working person who can tackle any CRM problem with ease. We have worked together on several projects, and I found him a highly skilled and dedicated professional. His expertise in the field of CRM helped the company immensely. He’s also an all-around great guy to work with! I highly recommend him to anyone looking for help on their team or CRM project.”`,
    },
    {
      name: "Teddy Yip",
