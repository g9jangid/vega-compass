...
export const metadata = getSEOTags(
  "Excel CRM-Atom | Simple & Scalable CRM for SMBs",
  "Manage sales and customer interactions effortlessly with Atom, an Excel-based CRM solution designed for small businesses."
);
